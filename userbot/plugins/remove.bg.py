...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("Connecting to official CrevilBot server and analysing this imgage...")
        try:
    ...
    if "image" in contentType:
        with io.BytesIO(output_file_name.content) as remove_bg_image:
            remove_bg_image.name = "@crevilSupport.png"
        ...
        await event.edit("Removed annoying Backgroup in {} seconds, powered by @crevilOfficial".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @crevilSupportl\n`{}".format(output_file_name.content.decode("UTF-8")))
